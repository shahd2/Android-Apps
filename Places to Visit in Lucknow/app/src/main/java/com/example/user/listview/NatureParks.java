...
public class NatureParks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nature_parks);
    ...
    class CustomAdapter extends BaseAdapter{
        ...
        public Object getItem(int position) {
            if(position == 0){
                startActivity(new Intent(NatureParks.this,Description1.class));
            }
            return null;
        }
