...
public class Breakfast extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter1 = new ArrayAdapter<String>(Breakfast.this, android.R.layout.simple_list_item_1, fruits);
        ...
        ArrayAdapter<String> arrayAdapter2 = new ArrayAdapter<String>(Breakfast.this, android.R.layout.simple_list_item_1, veg);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Breakfast.this, android.R.layout.simple_list_item_1, pro);
        ...
        ArrayAdapter<String> arrayAdapter4 = new ArrayAdapter<String>(Breakfast.this, android.R.layout.simple_list_item_1, cm);
        ...
        ArrayAdapter<String> arrayAdapter5 = new ArrayAdapter<String>(Breakfast.this, android.R.layout.simple_list_item_1, bev);
        ...
        btt.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                SharedPreferences sharedPreferences = getSharedPreferences("M1", MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString("breakfast", String.valueOf(cal));
                editor.commit();
                startActivity(new Intent(Breakfast.this, Addplan.class));
            }
        });
    }
            ...
            switch(v.getId()){
                case R.id.button1:
                   // fr=(EditText) findViewById(R.id.fser);
                    ...
                    Toast.makeText(Breakfast.this, "Item Added",
